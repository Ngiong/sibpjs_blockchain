...
class SimpleCard extends React.Component{
  render(){
    ...
    const actions = this.props.actions || <Button size="small" fullWidth onClick = { this.props.handleOnClick && this.props.handleOnClick.bind(this, this.props.documentId) }>View</Button>
    return (
